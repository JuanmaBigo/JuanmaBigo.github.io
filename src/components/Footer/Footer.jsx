    ...
    return (
        <div className='footer-container'>
            <div className='social-container'>
                ...
                <Link to='https://www.instagram.com/juanmabigo/' className='social-logo'>
                    <img className='social-logo-img' src='https://www.edigitalagency.com.au/wp-content/uploads/new-Instagram-logo-white-glyph.png' />
                </Link>
                <Link to='mailto:juanmateobigoritto@gmail.com' className='social-logo'>
                    <svg className='social-logo-img' xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" fill="white" class="bi bi-envelope-at-fill" viewBox="0 0 16 16">
