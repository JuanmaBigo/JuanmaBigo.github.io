...
export default function Projects() {
    return (
        <section className='projects-section'>
            <h2 className='title-h2'>{`<Projects Web/>`}</h2>
            ...
            <h2 className='title-h2'>{`<Projects Mobile/>`}</h2>
            <div className='projects'>
                <Project name={'Empire'} linkHost={'https://empire-project.netlify.app/'} linkRepo={'https://github.com/JuanmaBigo/Empire-Mobile'} img={empireMobile} projectMobile={true} /> {/* //TODO: cambiar links de host a video en yt */}
